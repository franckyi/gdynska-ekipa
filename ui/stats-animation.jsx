        ...
        <div className="stats-animation">
            <div className="flex flex-wrap gap-8 justify-between mb-12">
                <div className='box grow text-8xl text-amber-600 p-8 bg-stone-900 rounded-lg hover:bg-stone-800 transition-all duration-300'>
                    {stats.meta.years}+<span className={`block lg:inline text-lg text-stone-400 ${fontSecondary.className}`}> lat doświadczenia</span>
                    </div>   
                <div className='box grow text-8xl text-amber-600 p-8 bg-stone-900 rounded-lg hover:bg-stone-800 transition-all duration-300'>
                    {stats.meta.projects}+<span className={`text-lg text-stone-400 ${fontSecondary.className}`}> wykonanych projektów</span>
                    </div>
                <div className='box grow text-8xl text-amber-600 p-8 bg-stone-900 rounded-lg hover:bg-stone-800 transition-all duration-300'>
                    <span className={`block lg:inline text-lg text-stone-400 ${fontSecondary.className}`}>działaliśmy w </span>{stats.meta.cities}<span className={`text-lg text-stone-400 ${fontSecondary.className}`}>miastach</span>
                    </div>
            </div>
