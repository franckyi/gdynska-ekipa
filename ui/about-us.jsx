...
export default function AboutUs({content, btnText}) {
    ...
    return (
        <div className='my-32 mx-auto w-4/6 flex'>
            <div className='p-8 my-16 translate-x-8 flex flex-col justify-center text-left bg-stone-900'>
            ...
            <Image src={content.meta.image} width={700} height={400} alt="" />
        </div>
    )
}