...
export default async function Workflow({section}) {
    ...
    const headingClasses = 'mx-auto text-6xl w-3/4 text-center uppercase'
    const subheadingClasses = `text-center ${fontSecondary.className} text-lg`
    const processContainerClasses = "mt-16 workflow-steps flex justify-between"
    const processTitleClasses = "mt-4 mb-8 h-12 text-2xl font-bold text-amber-600"
